...
public class AreaController3 extends HttpServlet {
    private static final String TRI_RESULT_PAGE = "/lab3/TriangleCalc.jsp";
    private static final String CIRCLE_RESULT_PAGE = "/lab3/CircleCalc.jsp";
    private static final String RECTANGLE_RESULT_PAGE = "/lab3/RectangleCalc.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (rectangle != null && rectangle.equals(RECT_CALC)){
            ...
            request.getRequestDispatcher(RECTANGLE_RESULT_PAGE);
        ...
        if (circle != null && circle.equals(CIRC_CALC)){
            ...
            RequestDispatcher view =
            request.getRequestDispatcher(CIRCLE_RESULT_PAGE);
        view.forward(request, response);
        }
        ...
        if (triangle != null && triangle.equals(TRI_CALC)){
            ...
            RequestDispatcher view =
            request.getRequestDispatcher(TRI_RESULT_PAGE);
        view.forward(request, response);
        }
